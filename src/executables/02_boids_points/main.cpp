...
private:
	...
	void createComputePipeline()
	{
		...
		auto compShaderCode = readFile("../src/shaders/dummy/comp.spv");
	...
	{
		auto vertShaderCode = readFile("../src/shaders/dummy/vert.spv");
		auto fragShaderCode = readFile("../src/shaders/dummy/frag.spv");
